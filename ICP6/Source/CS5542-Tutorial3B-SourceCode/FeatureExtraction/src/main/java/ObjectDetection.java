...
class ObjectMainDetection {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("FeatureExtraction\\data1\\basketball1.mkv"));
        int count1 = 0, count2 = 0, count3 = 0;
        String o1 = "FeatureExtraction\\output1\\features.txt";
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("FeatureExtraction\\data1\\1.jpg"));
            modelImage2 = ImageUtilities.readMBF(new File("FeatureExtraction\\data1\\2.jpg"));
            modelImage3 = ImageUtilities.readMBF(new File("FeatureExtraction\\data1\\3.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
