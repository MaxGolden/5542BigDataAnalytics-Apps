...
public class ObjectFeatureExtraction {
    public static void main(String args[]) throws IOException {
        String inputFolder = "FeatureExtraction\\data1\\";
        String inputImage = "3Standing.jpg";
        String outputFolder = "FeatureExtraction\\output1\\";
        String[] IMAGE_CATEGORIES = {"running", "dunk", "standing"};
