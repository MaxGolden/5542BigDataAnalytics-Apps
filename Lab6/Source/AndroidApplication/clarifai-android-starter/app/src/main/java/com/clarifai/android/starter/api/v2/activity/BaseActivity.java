...
//  }
  ...
  public void browser1 (View view){
    Uri uri = Uri.parse("http://192.168.1.104:8081/#"); // missing 'http://' will cause crashed
//    Uri uri = Uri.parse("http://127.0.0.1:5000/#");
    Intent intent = new Intent(Intent.ACTION_VIEW, uri);
    startActivity(intent);
  }
  public void browser2 (View view){
    Uri uri = Uri.parse("http://192.168.1.104:8082/get_custom/"); // missing 'http://' will cause crashed
    Intent intent = new Intent(Intent.ACTION_VIEW, uri);
    startActivity(intent);
  }
  public void browser3 (View view){
    Uri uri = Uri.parse("http://192.168.1.104:5000/#"); // missing 'http://' will cause crashed
    Intent intent = new Intent(Intent.ACTION_VIEW, uri);
    startActivity(intent);
  }
