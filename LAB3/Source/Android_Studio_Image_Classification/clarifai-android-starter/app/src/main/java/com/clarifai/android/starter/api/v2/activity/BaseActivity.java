...
//  }
  ...
  public void browser1 (View view){
    Uri uri = Uri.parse("http://192.168.1.183:8080/get_custom"); // missing 'http://' will cause crashed
    Intent intent = new Intent(Intent.ACTION_VIEW, uri);
    startActivity(intent);
  }
  public void browser2 (View view){
    Uri uri = Uri.parse("http://192.168.1.183:8082/get_custom/"); // missing 'http://' will cause crashed
    Intent intent = new Intent(Intent.ACTION_VIEW, uri);
    startActivity(intent);
  }
  public void browser3 (View view){
    Uri uri = Uri.parse("http://192.168.1.183:8081/#"); // missing 'http://' will cause crashed
    Intent intent = new Intent(Intent.ACTION_VIEW, uri);
    startActivity(intent);
  }
